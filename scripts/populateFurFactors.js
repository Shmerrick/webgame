...
const props = JSON.parse(fs.readFileSync('public/fur_properties.json','utf8'));
const materials = Object.entries(props).map(([name, data])=> ({ name, class: 'Fur', ...data }));
...
console.log('Fur factors populated');
